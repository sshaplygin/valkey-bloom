...
valkey_module! {
    ...
    commands: [
        ...
        ["CF.ADD", cuckoo_add_command, "write deny-oom", 1, 1, 1, "write cuckoo"],
        ["CF.ADDNX", cuckoo_addnx_command, "write deny-oom", 1, 1, 1, "write cuckoo"],
        ...
        ["CF.INSERT", cuckoo_insert_command, "write deny-oom", 1, 1, 1, "write cuckoo"],
        ["CF.INSERTNX", cuckoo_insertnx_command, "write deny-oom", 1, 1, 1, "write cuckoo"],
